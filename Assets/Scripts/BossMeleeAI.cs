...
public class BossMeeleAI : MonoBehaviour
{
    GameObject player;
    ...
    void Update()
    {
        ...
        float healthScale = (float)enemy_lives / (float)enemy_lives_start;
        GetComponentInChildren<BossHealth>().scale = healthScale;
        Debug.Log("healthScale:" + healthScale);
    }
